...
\begin{dmath*}
  f_{X}(x) = \frac{1}{2\pi} \int_{-\infty}^{\infty} e^{-i \tau } e^{- |\tau|} d^\tau
           = \frac{1}{2\pi} \int _{-\infty \:}^0e^{-i \tau - (-\tau)} d\tau + \frac{1}{2\pi} \int _0^{\infty \:}e^{-i \tau - \tau} d\tau
           = \frac{1}{2\pi} \int _{-\infty \:}^0e^{\tau(-i + 1)} d\tau + \frac{1}{2\pi} \int _0^{\infty \:}e^{\tau (-i - 1)} d\tau
\end{dmath*}
